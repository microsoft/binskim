...
* BUG: Fix `BA2004.EnableSecureSourceCodeHashing` where if hash is not SHA256, now the actual hash found is reported instead of a hardcoded SHA-1. [#868](https://github.com/microsoft/binskim/pull/868)
