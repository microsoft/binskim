    ...
    public static class RulesExtensionMethods
    {
        ...
        private static Dictionary<CryptoError, string> BuildCryptoErrorDescriptions()
        {
            var result = new Dictionary<CryptoError, string>()
            {
                ...
                { CryptoError.TRUST_E_Error, "Generic trust failure." },
                ...
                { CryptoError.CERT_E_REVOCATION_ErrorURE, "The revocation process could not continue - the certificate(s) could not be checked." },
