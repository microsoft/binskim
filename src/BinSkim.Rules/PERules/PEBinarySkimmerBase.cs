    ...
    public abstract class PEBinarySkimmerBase : BinarySkimmer
    {
        public override AnalysisApplicability CanAnalyze(BinaryAnalyzerContext context, out string reasonForNotAnalyzing)
        {
            ...
            if (context.IsPE())
            {
                ...
                {
                    if (context.IgnoreExceptionInCanAnalyzeError)
                    {
        ...
        public static void LogExceptionInCanAnalyzeError(IAnalysisContext context, Exception ex)
        {
            ...
            if (context is BinaryAnalyzerContext binaryAnalyzerContext && !binaryAnalyzerContext.IgnoreExceptionInCanAnalyzeError)
            {
