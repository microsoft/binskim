...
namespace Microsoft.CodeAnalysis.IL.Rules {
    ...
    internal class RuleResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to &apos;{0}&apos; is a {1} which was not compiled with /INTEGRITYCHECK and therefore will not have its digital signature validated at load time. Failing to validate binary signatures increases the risk of loading malicious code in low-level, high-privilege execution environments, including subsystems that provide critical security malware protections..
        /// </summary>
        internal static string BA2101_Error {
            get {
                return ResourceManager.GetString("BA2101_Fail", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to &apos;{0}&apos; is a {1} which was compiled with /INTEGRITYCHECK and will therefore have its digital signature validated at load time when executing in sensitive Windows runtime environments..
        /// </summary>
