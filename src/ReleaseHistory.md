...
* BREAKING: Removed SARIF 1.0 support from BinSkim. Now option `-v | --sarif-output-version` does not accept value `OneZeroZero`. [718](https://github.com/microsoft/binskim/pull/718)
