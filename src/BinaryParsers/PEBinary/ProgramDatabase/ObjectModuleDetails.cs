...
namespace Microsoft.CodeAnalysis.BinaryParsers.ProgramDatabase
{
    ...
    public enum Language : uint
    {
        ...
        Cxx = 0x01,
        FORTRAN = 0x02,
        MASM = 0x03, // Microsoft Macro Assembler
        Pascal = 0x04,
        Basic = 0x05,
        COBOL = 0x06,
        LINK = 0x07, // linker-generated module
        CVTRES = 0x08, // resource module converted with CVTRES tool
        CVTPGD = 0x09, // POGO optimized module generated with CVTPGD tool
        CSharp = 0x0A,
        VisualBasic = 0x0B,
        ILASM = 0x0C, // intermediate language assembly (that is, Common Language Runtime (CLR) assembly)
        Java = 0x0D,
        JScript = 0x0E,
