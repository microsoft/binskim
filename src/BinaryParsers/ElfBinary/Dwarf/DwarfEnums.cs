...
namespace Microsoft.CodeAnalysis.BinaryParsers.Dwarf
{
    ...
    public enum DwarfAttribute
    {
        ...
        Reserved4 = 0x8,
        Ordering = 0x09,
        SubscrData = 0x0a, // Reserved?
        ByteSize = 0x0b,
        BitOffset = 0x0c, // Reserved for backward compatible support for DWARF v3 DW_AT_bit_offset
        BitSize = 0x0d,
        Reserved5 = 0x0e,
        ElementList = 0x0f, // Reserved?
        StmtList = 0x10,
        LowPc = 0x11,
        HighPc = 0x12,
        Language = 0x13,
        Member = 0x14, //Reserved?
        Discr = 0x15,
        DiscrValue = 0x16,
        Visibility = 0x17,
        Import = 0x18,
