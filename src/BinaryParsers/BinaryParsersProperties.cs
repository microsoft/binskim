    ...
    internal class BinaryParsersProperties : IOptionsProvider
    {
        public IEnumerable<IOption> GetOptions()
        {
            return new List<IOption>
            {
                ...
                SymbolPath,
                IgnoreExceptionInCanAnalyzeError
            }.ToImmutableArray();
        }
        ...
        public static PerLanguageOption<bool> IgnoreExceptionInCanAnalyzeError { get; } =
            new PerLanguageOption<bool>(
                "BinaryParsers", nameof(IgnoreExceptionInCanAnalyzeError), defaultValue: () => false,
