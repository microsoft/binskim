...
echo         public const string AssemblyVersion = "%MAJOR%.%MINOR%.%PATCH%.%REV%"; >> %VERSION_CONSTANTS%
echo         public const string FileVersion = "%MAJOR%.%MINOR%.%PATCH%.%REV%";     >> %VERSION_CONSTANTS%
